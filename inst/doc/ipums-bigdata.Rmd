...
the results, so it returns a list with one item per chunk containing the results.
...
## Option 3B: Work one 'yield' at a time
...
glm models on data larger than memory (as opposed to plain old lm's that 
