...
in shape files, which can be donloaded from our website (in slightly different
...
the same. In this case, I will use the harmonized vesrion, but other analyses
...
to usethe non-harmonized data for these 2 countries. Because the FUELCOOK variable
